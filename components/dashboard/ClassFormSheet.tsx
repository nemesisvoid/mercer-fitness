...
import { deleteClassImage } from "@/actions/class-action";
...
export function ClassFormSheet({
  ...
  const resolvedSubmitLabel =
    submitLabel ?? (isEditMode ? "Save changes" : "Publish class");
  ...
  const onValidSubmit: SubmitHandler<ClassFormValues> = async (values) => {
    try {
      ...
      const res = await onSubmit({
        ...
        endsAt: finalValues.endsAt
          ? new Date(finalValues.endsAt).toISOString()
          : undefined,
      });
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      />
                      <FieldDescription>
                        Required. Shown to members on the class booking page.
                      </FieldDescription>
                      {fieldState.invalid && (
                        <FieldError errors={[fieldState.error]} />
                      )}
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        ...
                        <DatePicker
                          ...
                          filterTime={(time) =>
                            time.getHours() >= 6 && time.getHours() <= 20
                          }
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        ...
                        />
                        <FieldDescription>
                          Optional. Leave blank for open-ended sessions.
                        </FieldDescription>
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
                        )}
          ...
          <div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-slate-500">
              {isEditMode
                ...
                : "Changes are previewed immediately in the sidebar."}
            </p>
...
//       />
//       <span>
//         <span className="block font-heading text-sm font-semibold text-slate-950">
//           {label}
//         </span>
